...
def create_movies_list():
    ...
    dead_poets_society = Movie('Dead Poets Society', '''\
                               ...
                               'https://images-na.ssl-images-amazon.com/images/M/MV5BOGYwYWNjMzgtNGU\
                               4ZC00NWQ2LWEwZjUtMzE1Zjc3NjY3YTU1XkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_SY1000_CR0,0,677,1000_AL_.jpg',
    ...
    usual_sus = Movie('The Usual Suspects', '''\
                      ...
                      'https://images-na.ssl-images-amazon.com/images/M/MV5BYTViNjMyNmUtNDF\
                      kNC00ZDRlLThmMDUtZDU2YWE4NGI2ZjVmXkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_SY1000_CR0,0,670,1000_AL_.jpg',
...
def create_tvshows_list():
    ...
    monty_python = TVSeries('Monty Python\'s Flying Circus ', '''\
                            ...
                            'https://images-na.ssl-images-amazon.com/images/M/MV5BNzY1MDE5OTY4Ml5BMl5a'
                            'BanBnXkFtZTgwOTAyNTQ1NjE@._V1_.jpg',
