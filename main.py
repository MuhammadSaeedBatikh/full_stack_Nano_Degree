...
def create_movies_list():
    ...
    mystic_river = Movie('Mystic River',
                         ...
                         'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYSMiwLB3Bdc2TG5PC2Gacv3CEFMlH2UeZtDvESUonATbBdm0J',
    ...
    dead_poets_society = Movie('Dead Poets Society', '''\
                               ...
                               'https://images-na.ssl-images-amazon.com/images/M/MV5BOGYwYWNjMzgtNGU4ZC00NWQ2LWEwZjUtMzE1Zjc3NjY3YTU1XkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_SY1000_CR0,0,677,1000_AL_.jpg',
    ...
    king_sp = Movie('The King\'s Speech', '''\
                    ...
                    'https://images-na.ssl-images-amazon.com/images/M/MV5BMzU5MjEwMTg2Nl5BMl5BanBnXkFtZTcwNzM3MTYxNA@@._V1_SY1000_CR0,0,684,1000_AL_.jpg',
    ...
    amadeus = Movie('Amadeus', '''\
                    ...
                    'https://images-na.ssl-images-amazon.com/images/M/MV5BMTg5NDkwMTk5N15BMl5BanBnXkFtZTYwODg3MDk2._V1_.jpg',
    ...
    c_kane = Movie('Citizen Kane', '''\
                   ...
                   'https://images-na.ssl-images-amazon.com/images/M/MV5BMTQ2Mjc1MDQwMl5BMl5BanBnXkFtZTcwNzUyOTUyMg@@._V1_.jpg',
